...
function createLexabitTheme(preset, mode) {
  ...
  return styles.createTheme(baseTheme, {
...
const ThemePresetContext = react.createContext(null);
...
function ThemePresetProvider({ presets, defaultPresetId, children }) {
  const [presetId, setPresetIdState] = react.useState(() => {
  ...
  const theme = react.useMemo(() => createLexabitTheme(currentPreset, "light"), [currentPreset]);
  const darkTheme = react.useMemo(() => createLexabitTheme(currentPreset, "dark"), [currentPreset]);
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(ThemePresetContext.Provider, { value, children });
}
...
exports.ThemePresetContext = ThemePresetContext;
exports.ThemePresetProvider = ThemePresetProvider;
exports.allPresets = allPresets;
exports.baseBreakpoints = baseBreakpoints;
exports.baseSpacing = baseSpacing;
exports.baseTransitions = baseTransitions;
exports.baseTypography = baseTypography;
exports.borderRadiusScale = borderRadiusScale;
exports.brandColors = brandColors;
exports.createLexabitTheme = createLexabitTheme;
exports.customBreakpoints = customBreakpoints;
exports.densityConfig = densityConfig;
exports.fontFamilies = fontFamilies;
exports.fontSizes = fontSizes;
exports.fontWeights = fontWeights;
exports.lexabitClassic = lexabitClassic;
exports.lexabitProfessional = lexabitProfessional;
exports.lineHeights = lineHeights;
exports.midnightFocus = midnightFocus;
exports.motionSpeed = motionSpeed;
exports.neutralColors = neutralColors;
exports.nordicFrost = nordicFrost;
exports.oceanBreeze = oceanBreeze;
exports.raComponentOverrides = raComponentOverrides;
exports.roleColors = roleColors;
exports.semanticColors = semanticColors;
exports.shadowPresets = shadowPresets;
exports.sharedComponentOverrides = sharedComponentOverrides;
exports.sourceColors = sourceColors;
exports.spacingScale = spacingScale;
exports.useDesignTokens = useDesignTokens;
exports.useThemePreset = useThemePreset;
exports.warmEarth = warmEarth;
